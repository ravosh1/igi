...
var rowCount = $('#table_id tbody tr').length;//document.getElementById('table_id').getElementsByTagName('tr');
var search_html;
...
$.extend( true, $.fn.dataTable.defaults, {
	...
	"oLanguage": {
	    "sLengthMenu": "View _MENU_ records | Found total " + rowCount + " records",
